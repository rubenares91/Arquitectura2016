...
public class ExtensionMapper {
	...
	public static java.lang.Object getTypeObject(java.lang.String namespaceURI, java.lang.String typeName,
		...
		if ("http://clases.dao.arq.pro/xsd".equals(namespaceURI) && "Cliente".equals(typeName)) {

			return pro.arq.dao.clases.xsd.Cliente.Factory.parse(reader);

		}

		if ("http://clases.dao.arq.pro/xsd".equals(namespaceURI) && "Ibex35".equals(typeName)) {

			return pro.arq.dao.clases.xsd.Ibex35.Factory.parse(reader);

		}

		if ("http://clases.dao.arq.pro/xsd".equals(namespaceURI) && "Peticion".equals(typeName)) {
		...
		if ("http://clases.dao.arq.pro/xsd".equals(namespaceURI) && "Cartera".equals(typeName)) {
