...
public class Main implements org.apache.axis2.databinding.ADBBean {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":main",
						xmlWriter);
			} else {
		...
		if (localArgsTracker) {
			if (localArgs != null) {
				...
				// write null attribute
				writeStartElement(null, "http://service.arq.pro", "args", xmlWriter);
		...
		public static Main parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"main".equals(type)) {
							...
							return (Main) pro.arq.service.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://service.arq.pro", "args").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "args").equals(reader.getName())) {
					...
					while (!loopDone1) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("http://service.arq.pro", "args")
