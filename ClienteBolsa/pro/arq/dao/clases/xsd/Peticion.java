...
public class Peticion implements org.apache.axis2.databinding.ADBBean {
	/*
	...
	public void setCantidad(int param) {
		...
		localCantidadTracker = param != java.lang.Integer.MIN_VALUE;
	...
	public void setIdPeticion(int param) {
		...
		// setting primitive attribute tracker to true
		localIdPeticionTracker = param != java.lang.Integer.MIN_VALUE;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (localCompraVentaTracker) {
			...
			if (false) {
				...
				xmlWriter.writeCharacters(
						org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCompraVenta));
			}
		...
		if (localFechaPeticionTracker) {
			...
			if (localFechaPeticion == null) {
				...
				xmlWriter.writeCharacters(
						org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFechaPeticion));
		...
		if (localIdPeticionTracker) {
			...
			if (localIdPeticion == java.lang.Integer.MIN_VALUE) {
				...
				xmlWriter.writeCharacters(
						org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIdPeticion));
			}
		...
		public static Peticion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Peticion".equals(type)) {
							...
							return (Peticion) pro.arq.service.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://clases.dao.arq.pro/xsd", "cantidad")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "cantidad").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "cantidad" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setCantidad(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://clases.dao.arq.pro/xsd", "compraVenta")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "compraVenta").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "compraVenta" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setCompraVenta(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://clases.dao.arq.pro/xsd", "dni")
								.equals(reader.getName())
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://clases.dao.arq.pro/xsd", "fechaPeticion")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "fechaPeticion").equals(reader.getName())) {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://clases.dao.arq.pro/xsd", "idPeticion")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "idPeticion").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "idPeticion" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setIdPeticion(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
