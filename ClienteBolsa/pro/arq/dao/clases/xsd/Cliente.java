...
public class Cliente implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Cliente
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":Cliente",
						xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Cliente", xmlWriter);
			}
		...
		if (localFechaInscripcionTracker) {
			...
			if (localFechaInscripcion == null) {
				...
				xmlWriter.writeCharacters(
						org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFechaInscripcion));
		...
		public static Cliente parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Cliente".equals(type)) {
							...
							return (Cliente) pro.arq.service.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://clases.dao.arq.pro/xsd", "direccion")
					...
					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						...
						object.setDireccion(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://clases.dao.arq.pro/xsd", "email")
								.equals(reader.getName())
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://clases.dao.arq.pro/xsd", "fechaInscripcion")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "fechaInscripcion").equals(reader.getName())) {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://clases.dao.arq.pro/xsd", "nombre")
								.equals(reader.getName())
